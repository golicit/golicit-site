...
export default function Careers() {
  return (
    <>
      <Helmet>
        <title>Careers at GoLicit - Join Our Team</title>
        <meta name="description" content="Join GoLicit's innovative team. Explore exciting career opportunities in technology, from software development to product management. Build your future with us." />
        <meta name="keywords" content="tech careers, software jobs, IT careers, technology jobs, career opportunities, job openings" />
      </Helmet>
      <div className="pt-16">
