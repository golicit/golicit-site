...
const stats = [
  ...
  { label: 'Team Members', value: '5+', color: 'from-indigo-500 to-purple-500' },
...
export default function About() {
  return (
    <>
      <Helmet>
        <title>About GoLicit Services - Our Story & Team</title>
        <meta name="description" content="Learn about GoLicit Services - Kolkata's innovative technology company. Discover our story, mission, and meet our expert team dedicated to transforming operations through intelligent cloud solutions." />
        <meta name="keywords" content="GoLicit team, technology company Kolkata, cloud solutions provider, ERP experts, digital transformation" />
      </Helmet>
      <div className="pt-16">
